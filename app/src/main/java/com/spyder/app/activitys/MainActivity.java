...
import static com.spyder.app.activitys.view.activities.Browser.BOOKMARKS_URI;
...
public class MainActivity extends BaseActivity implements SpyderContract.View {
    ...
    public void callLocationDetails() {
        ...
        locationDetail.setUserId(sharedPref.getUserId());
        /*locationDetail.setLattitude("17.459313");
        locationDetail.setLongitude("78.368570");*/
        locationDetail.setLattitude(getLattitude);
        locationDetail.setLongitude(getlangitude);
      //  locationDetail.setTimestamp("1517502985713");
        locationDetail.setTimestamp(timeStamp);
        ...
        db.addLocationDetails(new LocationDetail(locationDetail.getUserId(),locationDetail.getLattitude(),locationDetail.getLongitude(),locationDetail.getTimestamp()));
        // Reading all Location Details
        Log.d("Reading: ", "Reading all Location Details..");
   /*     List<LocationDetail> locationdetail = db.getALLLocationData();

        for (LocationDetail locationDetail1 : locationdetail) {
            String log = "Id: "+locationDetail1.getUserId()+" ,Lattitude: " + locationDetail1.getLattitude() + " ,Longitude: " + locationDetail1.getLongitude() + ",TimeStamp: "+ locationDetail1.getTimestamp();
            // Writing Contacts to log
            Log.d("Location Details: ", log);
        }*/
    }
    ...
    public void callSaveCallHistoryDetails() {
        ...
        callHistoryDetailsPojo.setUserId(sharedPref.getUserId());
        callHistoryDetailsPojo.setTimestamp(timeStamp);
    ...
    public void callGetCallHistoryDetails() {
        ...
        userId.setUserId(sharedPref.getUserId());
        MyLog.log("getcallHistoydetails", gson.toJson(userId));
       // showProgressDialog();
...
//        showProgressDialog();
    ...
    private  void getBrowserHistory(){
        ...
        mCur = this.managedQuery(BOOKMARKS_URI, proj, sel, null, null);
    ...
    private  void secondmethodBrowserHistory(){
    ...
    public void countDownTimer() {
        countDownTimer = new CountDownTimer(10000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                MyLog.log("count......", "" + millisUntilFinished / 1000);
            }
            ...
            public void onFinish() {
                ...
                getlangitude = gpsTrack.currentLangitude;
                getLattitude = gpsTrack.currentLattitude;
                MyLog.log("getting...",getlangitude +getLattitude);
                callLocationDetails();
              /*  callGetCallHistoryDetails();
                callSaveCallHistoryDetails();
                callPhotoDetails();*/
