...
public class GPSTrack extends Service implements LocationListener{
	...
	public String currentLangitude,currentLattitude;
						...
						try {
							...
							if (locationManager != null) {
								...
								if (location != null) {
                                    ...
                                    currentLattitude= String.valueOf(latitude);
                                    currentLangitude= String.valueOf(longitude);
									MyLog.log("network....",currentLattitude+currentLangitude);
							...
							try {
								...
								if (locationManager != null) {
									...
									if (location != null) {
										...
										currentLattitude= String.valueOf(latitude);
										currentLangitude= String.valueOf(longitude);
										MyLog.log("ravigpsEnabled",currentLattitude+currentLangitude);
									}
								}
							}catch (SecurityException e){
								e.printStackTrace();
